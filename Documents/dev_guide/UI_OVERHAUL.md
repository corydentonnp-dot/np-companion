...
| `Documents/dev_guide/UI_OVERHAUL.md` | This document |
...
## Implementation Status (as of Phase 44 Bite 2)

### Completed ✅

| System | Steps | Status |
|--------|-------|--------|
| 1A CSS Foundation | 1–3 | ✅ Done |
| 1B Base Template (subpanel block + toggle JS) | 4–6 | ✅ Done |
| 1B2 Popup Taskbar (ModalTaskbar + backdrop rewire) | 22–26 | ✅ Done |
| 1C Sub-panels — patient_roster.html | 7 | ✅ Done |
| 1C Sub-panels — timer.html | 8 | ✅ Done |
| 1C Sub-panels — inbox.html | 9 | ✅ Done |
| 1C Sub-panels — oncall.html | 10 | ✅ Done |
| 1C Sub-panels — orders.html | 11 | ✅ Done |
| 1C Sub-panels — labtrack.html | 12 | ✅ Done |
| 1C Sub-panels — caregap.html | 13 | ✅ Done |
| 1C Sub-panels — bonus_dashboard.html | 14 | ✅ Done |
| 1C Sub-panels — tcm_watch.html | 15 | ✅ Done |
| 1C Sub-panels — ccm_registry.html | 16 | ✅ Done |
| 1C Sub-panels — monitoring_calendar.html | 17 | ✅ Done |
| 1C Sub-panels — care_gaps_preventive.html | 18 | ✅ Done |
| 1C Sub-panels — staff_billing_tasks.html | 19 | ✅ Done |
| 1C Sub-panels — notifications.html | 20 | ✅ Done |
| 1C Sub-panels — patient_chart.html | 21 | ✅ Done |
| 2B Breadcrumb Trail | 40–43 | ✅ Done |
| 2C Type-Ahead Filtering | 44–46 | ✅ Done |
| 4A Page Transitions | 47–49 | ✅ Done |
| data-blocking on all 4 security modals | 26 | ✅ Done |
| data-filterable on all list/table pages | 46 | ✅ Done |
| **System 3 — Split View** (iframe approach) | 27–30 | ✅ Done (Bite 2) |
| **System 4 — PiP Widgets** (snapshot approach) | 31–34 | ✅ Done (Bite 2) |
| **System 5 — Smart Bookmarks with Folders** | 35–39 | ✅ Done (Bite 2) |
| **System 9D — Help Popovers** | 56–58 | ✅ Done (Bite 2) |

**Test suite:** 127/127 passing ✅  
**Bite 2 tests:** test_split_view (19/19), test_pip_widgets (20/20), test_bookmarks_folders (19/19), test_ai_enhancements (20/20) ✅

---

### Not Implemented — Requires Developer Action ❌

#### System 9A — AI Workflow Coach (Steps 50–51)

Implement AI-powered workflow suggestions. Requires:
- Encrypted `ai_api_key` column on `User` model — use `cryptography.fernet.Fernet` with `app.config['SECRET_KEY']`. Add migration.
- `ai_rate_limit_hourly` / `ai_rate_limit_daily` prefs (defaults 20/100) in Settings
- `window.__npRoutes` already injected in base.html — ✅ ready to use

#### System 9B — AI Natural Language Navigation (Steps 52)

Interpret typed commands as navigation intent. Requires AI API key (see 9A above).

#### System 9C — AI Writing Assistant (Steps 53–55)

Per-user AI-assisted text generation in order set builder, dot phrase editor, note composer, PA letter editor.

**What you need to do:**
1. Implement encrypted `ai_api_key` column + migration (shared with 9A)
2. Add `.ai-assist-icon` (✦ button) next to `<textarea>` and `contenteditable` fields in the above editors
3. Wire button to POST `/api/ai/suggest` with context snippet
