...
# --------------------------------------------------------------------------
#  F14b — Billing Anomaly Detector (helpers imported from timer_service — B1.15)
# --------------------------------------------------------------------------

# Resolution guidance per anomaly type (kept here for template rendering)
ANOMALY_GUIDANCE = {
...
# --------------------------------------------------------------------------
#  F14c — Monthly Billing Report  (helpers imported from timer_service — B1.15)
# --------------------------------------------------------------------------
