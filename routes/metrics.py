...
from app.services.metrics_service import generate_weekly_summary as _generate_weekly_summary  # B1.13
...
# _generate_weekly_summary is imported above from metrics_service (B1.13)
