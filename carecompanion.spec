...
"""
CareCompanion — PyInstaller Spec File

Build with:   pyinstaller --noconfirm carecompanion.spec
...
exe = EXE(
    ...
    icon=os.path.join(PROJECT, 'CareCompanion.ico') if os.path.isfile(os.path.join(PROJECT, 'CareCompanion.ico')) else None,
)
